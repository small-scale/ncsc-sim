    ...
    return {
        view: (vnode)=>{
            return m("button", {
                ...
                class:`f4-ns f6 center db tc pointer no-underline black bw2 bg-animate hover-bg-light-blue hover-navy bn  inline-flex items-center pa3 ba border-box ${vnode.attrs.class}`
                }, vnode.attrs.text)
        }
    }
}
